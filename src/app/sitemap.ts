...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPaths = ["", "/izrada-web-stranica-cijena", "/seo-optimizacija-cijena", "/izrada-web-trgovina", "/odrzavanje-web-stranica", "/cjenik", "/projekti", "/o-nama", "/o-meni", "/kontakt", "/blog"];
  return [
