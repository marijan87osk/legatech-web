...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPaths = ["", "/izrada-web-stranica-cijena", "/seo-optimizacija-cijena", "/izrada-web-trgovina", "/odrzavanje-web-stranica", "/cjenik", "/projekti", "/o-nama", "/kontakt", "/blog", "/politika-privatnosti", "/politika-kolacica", "/uvjeti-koristenja"];
  return [
